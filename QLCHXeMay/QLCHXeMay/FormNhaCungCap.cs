...
namespace QLCHXeMay
{
    public partial class FormNhaCungCap : Form
    {
        ...
        {
            dtGrdVwHienThi.DataSource = xl.loadNhaCungCap();
        }
        ...
        {
            if (xl.themNhaCungCap(txtMaNCC.Text, txtTenNCC.Text, txtSDT.Text, txtDiaChi.Text) == true)
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (dtGrdVwHienThi.CurrentRow != null)
            {
                ...
                if (xl.suaNhaCungCap(maSua, txtTenNCC.Text, txtSDT.Text, txtDiaChi.Text) == true)
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (dtGrdVwHienThi.CurrentRow != null)
            {
                ...
                if (xl.xoaNhaCungCap(maXoa) == true)
                {
        ...
        private void dtGrdVwHienThi_SelectionChanged(object sender, EventArgs e)
        {
            if (dtGrdVwHienThi.CurrentRow != null)
            {
                txtMaNCC.Text = dtGrdVwHienThi.CurrentRow.Cells[0].Value.ToString();
                txtTenNCC.Text = dtGrdVwHienThi.CurrentRow.Cells[1].Value.ToString();
